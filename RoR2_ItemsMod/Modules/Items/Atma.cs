...
namespace ExtradimensionalItems.Modules.Items
{
    public class Atma : ItemBase<Atma>
    {
        ...
        public override void AddBetterUIStats(ItemDef item)
        {
            ...
            BetterUICompat.RegisterStat(item, "BETTERUICOMPAT_DESC_DAMAGE", PercentBonusDamage.Value / 100, PercentBonusDamagePerStack.Value / 100, BetterUICompat.StackingFormulas.LinearStacking, BetterUICompat.StatFormatter.DamageFromHealth);
        }
